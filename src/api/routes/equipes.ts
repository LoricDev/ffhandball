...
import { equipeDetailSchema, equipeMatchsQuerySchema } from "@/api/schemas/equipe.api.js";
...
import { getEquipeDetail, getEquipeMatchs } from "@/api/lib/repositories/equipe.repo.js";
